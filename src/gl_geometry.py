...
def make_unit_cube():
    h = 1.0
    faces = [
        ((0, 0, 1), [(-h, -h, h), (h, -h, h), (h, h, h), (-h, -h, h), (h, h, h), (-h, h, h)]),
        ((0, 0, -1), [(-h, h, -h), (h, h, -h), (h, -h, -h), (-h, h, -h), (h, -h, -h), (-h, -h, -h)]),
        ((0, 1, 0), [(-h, h, -h), (-h, h, h), (h, h, h), (-h, h, -h), (h, h, h), (h, h, -h)]),
        ((0, -1, 0), [(-h, -h, -h), (h, -h, -h), (h, -h, h), (-h, -h, -h), (h, -h, h), (-h, -h, h)]),
        ((1, 0, 0), [(h, -h, -h), (h, h, -h), (h, h, h), (h, -h, -h), (h, h, h), (h, -h, h)]),
        ((-1, 0, 0), [(-h, -h, -h), (-h, -h, h), (-h, h, h), (-h, -h, -h), (-h, h, h), (-h, h, -h)]),
    ]
    verts = []
...
def make_ground_quad(size=30.0):
    s = size
    verts = np.array([-s, -s, 0, s, -s, 0, s, s, 0, -s, -s, 0, s, s, 0, -s, s, 0], dtype=np.float32)
    return verts, 6
