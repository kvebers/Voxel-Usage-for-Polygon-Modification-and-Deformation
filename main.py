...
from src.scene.component_factory import create_components, init_renderer, create_shooter
...
def main(scene_file="scene.json", record=None):
    ...
    shooter = create_shooter(scene, cfg)
    run_simulation_loop(scene, sim_state, camera, cfg, obj_list, joint_breakers, mesh_splitters, force_appliers, renderer, recorder, width, height, shooter)
    pygame.quit()
